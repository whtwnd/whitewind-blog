...
## 第2条（アカウント）
本サービスの利用においては、米Bluesky PBLLC（以下Bluesky社）の運営するPLCサーバへのアカウント登録もしくはdid:webを用いたアカウントが必要です。
本サービスの利用に起因しない理由、例えばBluesky社の利用規約違反等によりアカウントが使用不可能になった場合、当方は一切責任を負いません。
また、本サービスの利用に起因する理由でアカウントが使用不可能となった場合でも、当方の故意もしくは重過失によらない場合、当方は責任を追わないものとします。
...
ただし，当方は，本サービスを介して投稿ないしアップロードされた文章，画像，映像等について，本サービスの改良，品質の向上，または不備の是正等ならびに本サービスの周知宣伝等に必要な範囲で利用できるものとし，ユーザーは，この利用に関して，著作者人格権を行使しないものとします。
